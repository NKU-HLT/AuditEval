...
def load_model(ckpt_paths, device):
    ...
    print("[INFO] Loading CLAP upstream model: ./ckpt/laion_clap/630k-audioset-best.pt")
    with open(os.devnull, 'w') as f, contextlib.redirect_stdout(f):
        upstream_model = laion_clap.CLAP_Module(enable_fusion=False)
        upstream_model.load_ckpt('./ckpt/laion_clap/630k-audioset-best.pt')
...
if __name__ == "__main__":
    ckpt_paths = {
        "quality": "./ckpt/quality_epoch_50.pt",
        "relevance": "./ckpt/relevance_epoch_30.pt",
        "faithfulness": "./ckpt/faithfulness_epoch_35.pt"
    }
